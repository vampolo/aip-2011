...
<t:basepage>
    <jsp:attribute name="content">
      <div id="orientationInfo">
				<ul>
					<li>Gli alimenti biologici</li>
				</ul>
			</div>
			<div class="post">
				<h2 class="title"><a href="#">L'alimentazione biologica</a></h2>
				<p class="meta">Introduzione alla produzione biologica</p>
				<div class="entry">
					<p>
					<img src="images-junk/biologico.jpg" style="width: 200px;">
